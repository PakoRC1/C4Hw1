...
with(DT,plot(datehour,Global_active_power,type="l",xlab="",ylab="Global Active Power (kilowatts)"))
dev.copy(png,"./H1/plot2.png") #genera archivo png con la gráfica que se genera en la pantalla
dev.off()
